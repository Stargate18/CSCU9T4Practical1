...
public class TrainingRecordTest {
	...
	/**
	 * Test of addEntry method, of class TrainingRecord. You might want to extend
	 * this test when you implement the other Entry types
	 */
	@Test
	 ...
	 * Implement the method and then remove the "fail" line below and un-comment
	 * call to the method and the assertion line
	 */
	@Test
